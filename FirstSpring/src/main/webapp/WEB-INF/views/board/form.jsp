					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="/main.do">DDIT HOME</a></li>
						...
						<form class="card card-primary" method="post" action="/board/insert.do" id="boardForm">
							...
							<div class="card-body">
								<div class="form-group">
									...
									<input maxlength="133" type="text" id="boTitle" class="form-control" name="boTitle" value="${board.boTitle }" placeholder="제목을 입력해주세요">
								</div>
								<div class="form-group">
...
$(function(){
	...
	CKEDITOR.config.allowedContent = true; 	// 에디터를 사용할 때 종종 html태그가 사라질 때 있는데 이는  html태그가 사라지는 걸 방지
	
	var formBtn = $('#formBtn');
	
	formBtn.on("click", function(){
		var title = $("#boTitle").val().trim();	// 제목 데이터 얻어오기
//		var content = $("#boContent").val();// 내용 데이터 얻어오기 - but 에디터가 있을 때는 이런 방법으로 얻어올 수 없음
		var content = CKEDITOR.instances.boContent.getData().trim();	// 내용 데이터 얻어오기
