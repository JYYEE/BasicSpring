...
//import lombok.Data;
// 롬북을 이용하면 생성자, 수정된  setter, 새로 만든 메소드만 작성면됨
//@Data
public class PaginationInfoVO<T> { // <T> : 가변변수. 내가 지정한 타입에 맞춰서 변형.
	private int totalRecord;	// 총 게시글 수
	private int totalPage;		// 총 페이지 수
	private int currentPage;	// 현재 페이지
	private int screenSize = 10;// 한 페이지 당 게시글 수. 기본값 설정
	private int blockSize = 5;	// 페이지 블록 수. 기본값 설정
	...
	public void setCurrentPage(int currentPage) {
		...
		startPage = endPage - (blockSize -1);	// 시작페이지 = 마지막 페이지 - (페이지 블록 사이즈 -1)
	}
